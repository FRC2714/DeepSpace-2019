...
public class PID {
	...
	/*
	  ...
	  Affects output through <b>output+=previous_errorsIgain
	...
	/
	  ...
	  Affects output according to <b>output+=FSetpoint</b>. Note, that a F-only
	...
	/
	  ...
	  <pre>
	  output(1-strength)sum(0..n){outputstrength^n}
	  </pre>
